...
player_max_proposed_units = "You already have 3 proposed Units, which is the maximum allowed"
player_max_units = "You already have 25 Units, which is the maximum allowed (due to a discord limit, please contact Cheese)"
...
shop_repeatable_placeholder = "Max per unit (0 = unlimited)"
...
shop_repeatable_status = "Repeatable: {status}"  # status is "Unlimited" or "Max: N"
